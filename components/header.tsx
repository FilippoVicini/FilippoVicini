    ...
    <div className="max-w-5xl mx-auto px-6">
      <div className="w-full flex flex-col sm:flex-row justify-center sm:justify-between items-center">
        <div className="flex flex-col sm:flex-row items-center mb-4 sm:mb-0">
          <img src="/images/signature.png" className="w-48" alt="React Bricks" />
          <div className="sm:ml-8 flex space-x-5 text-center">
            <Link href="/portfolio">
              <a className="text-gray-500 hover:text-pink-700">Projects</a>
            </Link>
            <Link href="/about-us">
              <a className="text-gray-500 hover:text-pink-700">Ego</a>
            </Link>
            <Link href="/blog">
              <a className="text-gray-500 hover:text-pink-700">Expirience</a>
            </Link>
          </div>
        </div>
        <Link href="mailto:filippo.vicini2@gmail.com?subject=Hello%20Filippo!" prefetch={false}>
